!function(a, b, c, d) {
  ...
  var g = function(b, c) {
    return this.$element = a(b), this.elementId = b.id,
           this.styleId = this.elementId + '-style', this.init(c), {
      options: this.options, init: a.proxy(this.init, this),
  ...
  g.prototype.init =
    ...
    b.data &&
        ('string' == typeof b.data && (b.data = a.parseJSON(b.data)),
         this.tree = a.extend(!0, [], b.data), delete b.data),
    this.options = a.extend({}, f.settings, b), this.destroy(),
    this.subscribeEvents(), this.setInitialStates({nodes: this.tree}, 0),
    this.render()
  },
  g.prototype.remove =
      function() {
  ...
  g.prototype.destroy =
      function() {
    this.initialized &&
        (this.$wrapper.remove(), this.$wrapper = null, this.unsubscribeEvents(),
         this.initialized = !1)
  },
  g.prototype.unsubscribeEvents =
      function() {
    this.$element.off('click'), this.$element.off('nodeChecked'),
        this.$element.off('nodeCollapsed'), this.$element.off('nodeDisabled'),
        this.$element.off('nodeEnabled'), this.$element.off('nodeExpanded'),
        this.$element.off('nodeSelected'), this.$element.off('nodeUnchecked'),
        this.$element.off('nodeUnselected'),
        this.$element.off('searchComplete'), this.$element.off('searchCleared')
  },
  g.prototype.subscribeEvents =
      function() {
  ...
  g.prototype.setInitialStates =
      function(b, c) {
    if (b.nodes) {
      c += 1;
      var d = b, e = this;
      a.each(b.nodes, function(a, b) {
        b.nodeId = e.nodes.length, b.parentId = d.nodeId,
        ...
        b.state.hasOwnProperty('expanded') ||
            (!b.state.disabled&& c <
                     e.options.levels&& b.nodes&& b.nodes.length > 0 ?
                 b.state.expanded = !0 :
                 b.state.expanded = !1),
  ...
  g.prototype.clickHandler =
    ...
    if (d && !d.state.disabled) {
      ...
      -1 !== e.indexOf('expand-icon') ?
          ...
          (d.selectable ? this.toggleSelectedState(d, f.options) :
  ...
  g.prototype.toggleExpandedState =
      function(a, b) {
    a && this.setExpandedState(a, !a.state.expanded, b)
  },
  g.prototype.setExpandedState =
      function(b, c, d) {
    c !== b.state.expanded &&
        (c && b.nodes ?
             (b.state.expanded = !0,
                 ...
                 (b.state.expanded = !1,
                  d.silent ||
                      this.$element.trigger(
                          'nodeCollapsed', a.extend(!0, {}, b)),
                  b.nodes && !d.ignoreChildren &&
                      a.each(b.nodes, a.proxy(function(a, b) {
                        this.setExpandedState(b, !1, d)
                      }, this))))
  },
  g.prototype.toggleSelectedState =
      function(a, b) {
  ...
  g.prototype.toggleCheckedState =
      function(a, b) {
    a && this.setCheckedState(a, !a.state.checked, b)
  },
  g.prototype.setCheckedState =
      function(b, c, d) {
    c !== b.state.checked &&
        (c ? (b.state.checked = !0,
              d.silent ||
  ...
  g.prototype.setDisabledState =
      function(b, c, d) {
    c !== b.state.disabled &&
        (c ? (b.state.disabled = !0, this.setExpandedState(b, !1, d),
              this.setSelectedState(b, !1, d), this.setCheckedState(b, !1, d),
              d.silent ||
  ...
  g.prototype.render =
      function() {
    this.initialized ||
        (this.$element.addClass(e), this.$wrapper = a(this.template.list),
         this.injectStyle(), this.initialized = !0),
        this.$element.empty().append(this.$wrapper.empty()),
        this.buildTree(this.tree, 0)
  },
  g.prototype.buildTree =
      function(b, c) {
    if (b) {
      c += 1;
      var d = this;
      a.each(b, function(b, e) {
        ...
        if (e.nodes ? (h.push('expand-icon'),
                       h.push(
                           e.state.expanded ? d.options.collapseIcon :
          ...
          h.push(e.icon || d.options.nodeIcon),
              ...
              (h.pop(),
               h.push(
                   e.selectedIcon || d.options.selectedIcon || e.icon ||
                   d.options.nodeIcon)),
              f.append(a(d.template.icon).addClass(h.join(' ')))
        }
        if (d.options.showCheckbox) {
          var h = ['check-icon'];
          h.push(
              e.state.checked ? d.options.checkedIcon :
  ...
  g.prototype.buildStyleOverride =
      function(a) {
    ...
    return this.options.highlightSelected && a.state.selected &&
           ...
           this.options.highlightSearchResults && a.searchResult &&
               !a.state.disabled &&
  ...
  g.prototype.injectStyle =
      function() {
    this.options.injectStyle && !c.getElementById(this.styleId) &&
        a('<style type="text/css" id="' + this.styleId + '"> ' +
  ...
  g.prototype.buildStyle =
    ...
    return this.options.color && (a += 'color:' + this.options.color + ';'),
           ...
           this.options.showBorder ? this.options.borderColor &&
                   (a += 'border:1px solid ' + this.options.borderColor + ';') :
                                     a += 'border:none;',
           a += '}',
           this.options.onhoverColor &&
               (a += '.node-' + this.elementId +
  ...
  g.prototype.getNode = function(a) {
    ...
    c = a.extend({}, f.options, c), b instanceof Array || (b = [b]),
    ...
    if (b && b.length > 0) {
      c.exactMatch && (b = '^' + b + '$');
      var e = 'g';
      c.ignoreCase && (e += 'i'), d = this.findNodes(b, e),
                                  a.each(d, function(a, b) {
                                    b.searchResult = !0
                                  })
    }
    return c.revealResults ? this.revealNode(d) : this.render(),
           this.$element.trigger('searchComplete', a.extend(!0, {}, d)), d
  ...
  a.fn[e] = function(b, c) {
    ...
    return this.each(function() {
      var f = a.data(this, e);
      'string' == typeof b ?
          f ? a.isFunction(f[b]) && '_' !== b.charAt(0) ?
